# AGENTS.md — Temporal dispatch allow-list (для project-specific agent)

Этот файл — инструкция агенту, работающему в **project fork** gortex, по
сопровождению распознавания Temporal-диспатча под ваш кодовой базы. Цель: повышать точность
графа Temporal **без утечки project identifiers** в исходники / upstream.
...
## 3. Протокол анонимизации (не спалить project)
