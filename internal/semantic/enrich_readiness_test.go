...
func TestRunEnrichOne_ReadinessGate(t *testing.T) {
	...
	results := mgr.runEnrichOne(graph.New(), "repo", "/tmp/repo", "csharp", p, 10, RepoEnrichState{}, nil, nil, map[string]bool{})
...
func TestRunEnrichOne_FastProviderSkipsReadiness(t *testing.T) {
	...
	results := mgr.runEnrichOne(graph.New(), "repo", "/tmp/repo", "go", p, 10, RepoEnrichState{}, nil, nil, map[string]bool{})
