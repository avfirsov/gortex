...
// Resolution-outcome taxonomy constants. These mirror the MCP-layer
// constants so any caller that wants to compare against them can import
// from here rather than the mcp package.
const (
